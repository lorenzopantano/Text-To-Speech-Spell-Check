...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener, SpellCheckerSession.SpellCheckerSessionListener {
    ...
    *  */
    ...
    protected void onResume() {
        ...
        if (textServicesManager != null) {
            ...
            Toast.makeText(MainActivity.this, "Error at the spell checker initializer", Toast.LENGTH_SHORT).show();
        }
    ...
    class UtteranceProgList extends UtteranceProgressListener {
        ...
        public void onStart(String utteranceId) {
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    Toast toast = Toast.makeText(MainActivity.this, "Staring...", Toast.LENGTH_SHORT);
                    toast.show();
                }
            });
        }
        ...
        public void onError(String utteranceId) {
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                @Override
                public void run() {
                    Toast toast = Toast.makeText(MainActivity.this, "An error occurred, try again later and check you internet connection", Toast.LENGTH_LONG);
                    toast.show();
                }
            });
        }
            ...
            switch (v.getId()) {
                ...
                case R.id.btnPlay:
                    ...
                    if (etInputText.getText().length() > TextToSpeech.getMaxSpeechInputLength()) {
                        Toast.makeText(MainActivity.this, "Text is too long!", Toast.LENGTH_SHORT).show();
                    }
                ...
                case R.id.btnLanguage:
                    ...
                    Intent langIntent = new Intent(MainActivity.this, ChangeLanguageActivity.class);
